...
// Fix details
std::string sFixName = "LegoRacers2WidescreenFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::LR2, {"LEGO Racers 2", "LEGO Racers 2.exe"}},
};
...
void WidescreenFix()
{
	if (eGameType == Game::LR2 && bFixActive == true)
	{
		...
		{
			spdlog::error("Failed to locate 800x600 resolution scan memory address.");
			return;
		}
