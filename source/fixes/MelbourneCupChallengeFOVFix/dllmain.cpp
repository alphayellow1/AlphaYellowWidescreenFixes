	...
	void ApplyFix() override
	{
		...
		if (m_resolutionScanResult)
		{
			...
			m_resolutionHook = safetyhook::create_mid(m_resolutionScanResult, [](SafetyHookContext& ctx)
			{
				...
				spdlog::info("Current res: {}x{}, New aspect ratio: {}, Aspect ratio scale: {}", s_instance_->m_newResX, s_instance_->m_newResY, s_instance_->m_newAspectRatio, s_instance_->m_aspectRatioScale);
			});
		}
		else
		{
