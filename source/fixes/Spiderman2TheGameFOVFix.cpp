...
double currentCameraFOV, newCameraFOV, newCameraFOVValue, oldWidth = 4.0, oldHeight = 3.0, oldCameraHorizontalFOV = 60.0, oldAspectRatio = oldWidth / oldHeight;
string input;
fstream file;
char ch;
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            newCameraFOV = NewCameraFOVCalculation(newWidth, newHeight, oldCameraHorizontalFOV = 60.0);
