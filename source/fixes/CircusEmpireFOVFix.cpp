...
const streampos kCameraFOVOffset = 0x00098567;

// Variables
int choice1, choice2, tempChoice;
uint32_t newWidth, newHeight;
bool fileNotFound, validKeyPressed;
float currentCameraFOVInRadians, currentCameraFOVInDegrees, newCameraFOVInRadians, newCameraFOVInDegrees, newCameraFOVInDegreesValue, oldWidth = 4.0f, oldHeight = 3.0f, oldHorizontalFOV = 70.000007f, oldAspectRatio = oldWidth / oldHeight, newAspectRatio;
...
int main()
{
    ...
    cout << "Circus Empire (2006) FOV Fixer v1.0 by AlphaYellow, 2024\n\n----------------\n";
    ...
    do
    {
        ...
        case 2:
            cout << "\n- Enter the desired FOV (in degrees, default for 4:3 aspect ratio is 70\u00B0): ";
        ...
        if (file.good())
        {
            ...
            cout << "\nSuccessfully " << descriptor << " the field of view to " << newCameraFOVInDegrees << "\u00B0."
                 << endl;
        }
        else
        {
