...
class ExtremeBikerFix final : public FixBase
{
public:
	explicit ExtremeBikerFix(HMODULE selfModule) : FixBase(selfModule)
	{
		s_instance_ = this;
	}

	~ExtremeBikerFix() override
	{
		if (s_instance_ == this)
		{
			s_instance_ = nullptr;
...
protected:
	...
	{
		return "EdgarTorronterasExtremeBikerWidescreenFix";
	}
	...
	{
		return "Edgar Torronteras' eXtreme Biker";
	}
	...
	{
		return Util::stringcmp_caseless(exeName, "E-Biker.exe");
	}
...
private:
	...
	inline static ExtremeBikerFix* s_instance_ = nullptr;
};

static std::unique_ptr<ExtremeBikerFix> g_fix;
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved)
{
	...
	case DLL_PROCESS_ATTACH:
	{
		...
		g_fix = std::make_unique<ExtremeBikerFix>(hModule);
		g_fix->Start();
		break;
	}
