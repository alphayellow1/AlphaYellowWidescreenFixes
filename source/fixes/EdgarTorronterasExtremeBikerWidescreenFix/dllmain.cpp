...
// Fix details
std::string sFixName = "EdgarTorronterasExtremeBikerWidescreenFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::ETEB, {"Edgar Torronteras' eXtreme Biker", "E-Biker.exe"}},
};
...
void WidescreenFix()
{
	if (bFixActive == true && eGameType == Game::ETEB)
	{
