...
// Fix details
std::string sFixName = "SeaWorldAdventureParksTycoon2FOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::SWAPT2, {"SeaWorld Adventure Parks Tycoon 2", "swt3d.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::SWAPT2 && bFixActive == true)
	{
		...
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "89 81 24 02 00 00 8B 44 24 0C 89 91 2C 02 00 00 8B 54 24 10 89 81 30 02 00 00");
		if (CameraFOVInstructionScanResult)
		{
			...
			{
				// Store the current FOV value located in the EAX register value in a float variable
				...
				// Update the EAX register with the new FOV value
