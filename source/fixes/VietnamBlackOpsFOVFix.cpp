...
const float kDefaultCameraVerticalFOVInRadians = 1.1780972480773926f; // 67.5 degrees
const streampos kCameraHorizontalFOVOffset = 0x00076DE6;
const streampos kCameraVerticalFOVOffset = 0x00076E06;

// Variables
int choice1, choice2, tempChoice;
uint32_t newWidth, newHeight;
bool fileNotFound, validKeyPressed;
float currentCameraHorizontalFOVInRadians, currentCameraVerticalFOVInRadians, currentCameraHorizontalFOVInDegrees, currentCameraVerticalFOVInDegrees, newCameraHorizontalFOVInRadians, newCameraVerticalFOVInRadians, newCameraHorizontalFOVInDegrees, newCameraHorizontalFOVInDegreesValue, newCameraVerticalFOVInDegrees, oldWidth = 4.0f, oldHeight = 3.0f, oldCameraHorizontalFOV = 90.0f, oldAspectRatio = oldWidth / oldHeight;
...
int main()
{
    ...
    do
    {
        ...
        cout << "\nCurrent FOV: " << currentCameraHorizontalFOVInDegrees << " degrees (Horizontal); " << currentCameraVerticalFOVInDegrees << " degrees (Vertical)\n";
        ...
        case 1:
            ...
            newCameraHorizontalFOVInDegrees = 2.0 * RadToDeg(atan((newAspectRatio / oldAspectRatio) * tan(DegToRad(oldCameraHorizontalFOV / 2.0))));
