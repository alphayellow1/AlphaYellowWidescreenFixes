...
#include <iomanip>
#include <fstream>
#include <cstdint> // For unin32_t variable type
#include <cmath>
#include <limits>
#include <conio.h>
#include <string>
...
const float kDefaultCameraVerticalFOVInRadians = 1.178097248f;
...
int main()
{
    ...
    cout << "Die Hard: Nakatomi Plaza (2002) FOV Fixer v1.0 by AlphaYellow, 2024\n\n----------------\n";
    ...
    do
    {
        ...
        cout << "\n- Do you want to set FOV automatically based on a desired resolution (1) or set custom horizontal and vertical FOV values (2)?: ";
