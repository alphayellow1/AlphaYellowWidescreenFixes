...
class DangerousHunts2013Fix final : public FixBase
{
public:
	explicit DangerousHunts2013Fix(HMODULE selfModule) : FixBase(selfModule)
	{
		s_instance_ = this;
	}

	~DangerousHunts2013Fix() override
	{
		if (s_instance_ == this)
		{
			s_instance_ = nullptr;
...
protected:
	...
	{
		return "CabelasDangerousHunts2013WidescreenFix";
	}
	...
	{
		return "Cabela's Dangerous Hunts 2013";
	}
	...
	{
		return Util::stringcmp_caseless(exeName, "dh_2013.exe");
	}
...
private:
	...
	inline static DangerousHunts2013Fix* s_instance_ = nullptr;
};

static std::unique_ptr<DangerousHunts2013Fix> g_fix;
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved)
{
	...
	case DLL_PROCESS_ATTACH:
	{
		...
		g_fix = std::make_unique<DangerousHunts2013Fix>(hModule);
		g_fix->Start();
		break;
	}
