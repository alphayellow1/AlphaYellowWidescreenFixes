...
const streampos kFOV1Offset = 0x0000C4BB;
const streampos kFOV2Offset = 0x0000E20F;
const streampos kFOV3Offset = 0x0000E216;
const streampos kFOV4Offset = 0x0003468A;
