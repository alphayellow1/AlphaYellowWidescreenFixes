...
void WidescreenFix()
{
	if (eGameType == Game::SAER && bFixActive == true)
	{
		...
		if (Resolution1ScanResult)
		{
			...
			Memory::Write(Resolution1ScanResult + 6, iCurrentResX);

			Memory::Write(Resolution1ScanResult + 1, iCurrentResY);
		}
		else
		{
		...
		if (Resolution2ScanResult)
		{
			...
			Memory::Write(Resolution2ScanResult + 6, iCurrentResX);

			Memory::Write(Resolution2ScanResult + 1, iCurrentResY);
		}
		else
		{
		...
		if (Resolution4ScanResult)
		{
			...
			Memory::Write(Resolution4ScanResult + 1, iCurrentResY);
		}
		else
		{
		...
		if (Resolution5ScanResult)
		{
			...
			Memory::Write(Resolution5ScanResult + 6, iCurrentResX);

			Memory::Write(Resolution5ScanResult + 1, iCurrentResY);
		}
		else
		{
		...
		if (Resolution6ScanResult)
		{
			...
			Memory::Write(Resolution6ScanResult + 6, iCurrentResX);

			Memory::Write(Resolution6ScanResult + 1, iCurrentResY);
		}
		else
		{
