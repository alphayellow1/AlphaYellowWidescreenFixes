...
// Fix details
std::string sFixName = "UltimateRideCoasterDeluxeWidescreenFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::URCD, {"Ultimate Ride Coaster Deluxe", "URideDx.exe"}},
};
...
void WidescreenFix()
{
	if (eGameType == Game::URCD && bFixActive == true)
	{
		...
		std::uint8_t* ResolutionListScanResult = Memory::PatternScan(exeModule, "C7 01 00 04 00 00 C7 02 00 03 00 00 C3 8B 44 24 08 8B 4C 24 0C C7 00 80 04 00 00 C7 01 60 03 00 00 C3 8B 54 24 08 8B 44 24 0C C7 02 00 05 00 00 C7 00 C0 03 00 00 C3 8B 4C 24 08 8B 54 24 0C C7 01 40 06 00 00 C7 02 B0 04 00 00 C3 8B 44 24 08 8B 4C 24 0C C7 00 80 02 00 00 C7 01 E0 01 00 00 C3 8B 54 24 08 8B 44 24 0C C7 02 20 03 00 00 C7 00 58 02 00 00 C3 90 91 78 49 00 A6 78 49 00 BB 78 49 00 D0 78 49 00 E5 78 49 00 90 90 90 90 90 90 90 90 90 90 90 90 8B 44 24 04 8B 4C 24 08 C7 00 20 03 00 00 C7 01 58 02 00 00");
