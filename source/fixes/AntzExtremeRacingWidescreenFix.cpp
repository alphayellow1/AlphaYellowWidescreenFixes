...
void SearchAndReplacePatterns(fstream &file)
{
    ...
    vector<pair<const char *, size_t>> patterns = {
        ...
        // 00436A74 | D9 40 3C | fld dword ptr [eax+3C]
        // 00436A77 | D8 49 28 | fmul dword ptr [ecx+28]
        // 00436A7A | D9 5D F8 | fstp dword ptr [ebp-8]
        // 00436A7D | 8B 55 08 | mov edx,[ebp+8]
        // 00436A80 | 8B 45 08 | mov eax,[ebp+8]
        // 00436A83 | D9 42 40 | fld dword ptr [edx+40]
        // 00436A86 | D8 48 28 | fmul dword ptr [eax+28]
    ...
    vector<pair<const char *, size_t>> replacements = {
        ...
        // 00436A74 | E9 47 BD 10 00 | jmp 005427C0
        // 00436A79 | 90             | nop
        // 00436A7A | D9 5D F8       | fstp dword ptr [ebp-8]
        // 00436A7D | 8B 55 08       | mov edx,[ebp+8]
        // 00436A80 | 8B 45 08       | mov eax,[ebp+8]
        // 00436A83 | E9 4A BD 10 00 | jmp 005427D2
        // 00436A88 | 90             | nop
        ...
        // 005427C0 | C7 40 3C 00 00 00 40 | mov [eax+3C],40000000
        // 005427C7 | D9 40 3C             | fld dword ptr [eax+3C]
        // 005427CA | D8 49 28             | fmul dword ptr [ecx+28]
        // 005427CD | E9 A8 42 EF FF       | jmp 00436A7A
        // 005427D2 | C7 42 40 00 00 00 40 | mov dword ptr [edx+40],40000000
        // 005427D9 | D9 42 40             | fld dword ptr [edx+40]
        // 005427DC | D8 48 28             | fmul dword ptr [eax+28]
        // 005427DF | E9 A5 42 EF FF       | jmp 00436A89
    };
