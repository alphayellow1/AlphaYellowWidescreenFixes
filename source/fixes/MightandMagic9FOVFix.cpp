...
const streampos kCameraHorizontalFOVOffset = 0x00081956;
const streampos kCameraVerticalFOVOffset = 0x00081971;
...
int main()
{
    ...
    cout << "Might and Magic IX (2002) FOV Fixer v1.1 by AlphaYellow, 2024\n\n----------------\n";
