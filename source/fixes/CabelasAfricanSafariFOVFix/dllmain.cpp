...
const std::map<Game, GameInfo> kGames = {
	{Game::CAS, {"Cabela's African Safari", "CAS.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::CAS && bFixActive == true)
	{
		...
		if (CameraFOVInstructionScanResult)
		{
			...
			CameraFOVInstructionHook = safetyhook::create_mid(CameraFOVInstructionScanResult, [](SafetyHookContext& ctx)
			{
				...
				{
					fNewCameraFOV = fFOVFactor * Maths::CalculateNewFOV_DegBased(fCurrentCameraFOV, fAspectRatioScale);
				}
				else
				{
