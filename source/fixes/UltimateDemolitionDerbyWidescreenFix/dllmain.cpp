...
void WidescreenFix()
{
	if (eGameType == Game::UDD && bFixActive == true)
	{
		...
		if (ResolutionInstructionsScanResult)
		{
			...
			ResolutionWidthAddress = Memory::GetPointer<uint32_t>(ResolutionInstructionsScanResult + 2, Memory::PointerMode::Absolute);;

			ResolutionHeightAddress = Memory::GetPointer<uint32_t>(ResolutionInstructionsScanResult + 11, Memory::PointerMode::Absolute);
		...
		if (CameraFOVInstructionScanResult)
		{
			...
			CameraVFOVAddress = Memory::GetPointer<uint32_t>(CameraFOVInstructionScanResult + 46, Memory::PointerMode::Absolute);
