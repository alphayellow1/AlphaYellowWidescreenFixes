...
// Fix details
std::string sFixName = "AirportTycoon3FOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::AT3, {"Airport Tycoon 3", "at3.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::AT3 && bFixActive == true)
	{
		...
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "D9 46 40 8D 44 24 18 D8 0D 18 01 54 00 50 8B CF D9 F2 DD D8");
