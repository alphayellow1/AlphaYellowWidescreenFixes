...
void FOVFix()
{
	if (eGameType == Game::SRE && bFixActive == true)
	{
		...
		std::uint8_t* AspectRatioInstructionScanResult = Memory::PatternScan(exeModule, "D8 4E 3C D9 5A 14 D9 52 28 D8 4E 30");
		...
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "D8 49 58 DC C0 D9 5C 24 04 D9 41 50 D8 2D ?? ?? ?? ??");
