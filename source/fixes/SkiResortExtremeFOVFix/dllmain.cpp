...
// Fix details
std::string sFixName = "SkiResortExtremeFOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::SRE, {"Ski Resort Extreme", "SRE.exe"}},
};
...
{
	float& fCurrentAspectRatio = *reinterpret_cast<float*>(ctx.esi + 0x3C);

	if (fCurrentAspectRatio == 1.33333333333f)
	{
...
void FOVFix()
{
	if (eGameType == Game::SRE && bFixActive == true)
	{
