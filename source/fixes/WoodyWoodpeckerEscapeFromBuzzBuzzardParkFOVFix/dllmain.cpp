...
void FOVFix()
{
	if (eGameType == Game::WWEFBB && bFixActive == true)
	{
		...
		if (AspectRatioAndCameraFOVInstructionsScanResult)
		{
			...
			AspectRatioAddress = Memory::GetPointerFromAddress(AspectRatioAndCameraFOVInstructionsScanResult + 2, Memory::PointerMode::Absolute);

			CameraFOVAddress = Memory::GetPointerFromAddress(AspectRatioAndCameraFOVInstructionsScanResult + 8, Memory::PointerMode::Absolute);
