...
// Fix details
std::string sFixName = "SnowRiderFOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::SR, {"Snow Rider", "SnowRider.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::SR && bFixActive == true)
	{
		...
		std::uint8_t* AspectRatioInstruction1ScanResult = Memory::PatternScan(exeModule, "D8 8E EC 02 00 00 D8 8A CC 00 00 00 D9 44 24 28 D8 8A CC 00 00 00 D9 C1");
		...
		std::uint8_t* CameraFOVInstruction3ScanResult = Memory::PatternScan(exeModule, "8B 93 E8 02 00 00 50 51 8D B3 D4 03 00 00 52 8B CE");
		if (CameraFOVInstruction3ScanResult)
		{
			...
			{
				float& fCurrentCameraFOV3 = Memory::ReadMem(ctx.ebx + 0x2E8);
