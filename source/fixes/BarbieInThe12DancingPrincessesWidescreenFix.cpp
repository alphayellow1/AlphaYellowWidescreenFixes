...
const streampos kHorizontalFOVOffset = 0x000E9F50;
...
double newHorizontalCameraFOV, newHorizontalCameraFOVValue;
char ch;
...
double NewHorizontalFOVCalculation(uint32_t &newWidthValue, uint32_t &newHeightValue)
{
    newHorizontalCameraFOVValue = (4.0 / 3.0) / (static_cast<double>(newWidthValue) / static_cast<double>(newHeightValue));
...
int main()
{
    ...
    do
    {
        OpenFile(file, "Barbie(TM) In The 12 Dancing Princesses.exe");
