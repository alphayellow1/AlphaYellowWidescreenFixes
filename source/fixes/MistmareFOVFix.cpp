...
const streampos kHFOVOffset = 0x0017ED67;
const streampos kVFOVOffset = 0x0017ED7C;
const float kDefaultVFOVInRadians = 0.9817477042;

// Variables
int choice1, choice2, tempChoice;
bool fileNotFound, validKeyPressed;
double oldWidth = 4.0, oldHeight = 3.0, oldHFOV = 75.0, oldAspectRatio = oldWidth / oldHeight, newAspectRatio, newWidth, newHeight, currentHFOVInDegrees, currentVFOVInDegrees, newHFOVInDegrees, newVFOVInDegrees, newCustomFOVInDegrees, newCustomResolutionValue;
...
int main()
{
    ...
    cout << "Mistmare (2003) FOV Fixer v1.0 by AlphaYellow, 2024\n\n----------------\n";
