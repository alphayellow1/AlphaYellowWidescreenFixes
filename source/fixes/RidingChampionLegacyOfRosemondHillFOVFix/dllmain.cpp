	...
	if (eGameType == Game::RCLORH && bFixActive == true)
	{
        ...
        if (bCameraFOV2Done == false)
        {
            ...
            if (CameraFOVInstruction2ScanResult)
            {
                ...
                CameraFOV2Address = Memory::GetPointerFromAddress(CameraFOVInstruction2ScanResult + 2, Memory::PointerMode::Absolute);
        ...
        if (bCameraFOV3Done == false)
        {
            ...
            if (CameraFOVInstruction3ScanResult)
            {
                ...
                CameraFOV3Address = Memory::GetPointerFromAddress(CameraFOVInstruction3ScanResult + 2, Memory::PointerMode::Absolute);
