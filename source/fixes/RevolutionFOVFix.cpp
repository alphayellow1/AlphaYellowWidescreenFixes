...
const streampos kCameraFOVOffset = 0x002D5D86;

// Variables
int choice1, choice2, tempChoice;
uint32_t newWidth, newHeight;
bool fileNotFound, validKeyPressed;
double currentCameraFOV, newCameraFOV, newCameraFOVValue, oldWidth = 4.0, oldHeight = 3.0, oldCameraHorizontalFOV = 90.0, oldAspectRatio = oldWidth / oldHeight;
...
int main()
{
    ...
    do
    {
        ...
        if (file.good())
        {
            ...
            cout << "\nSuccessfully changed " << descriptor << " the field of view to " << newCameraFOV << "\u00B0." << endl;
        }
        else
        {
