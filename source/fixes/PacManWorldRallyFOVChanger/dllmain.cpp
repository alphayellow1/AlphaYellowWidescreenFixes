...
// Fix details
std::string sFixName = "PacManWorldRallyFOVChanger";
...
const std::map<Game, GameInfo> kGames = {
	{Game::PMWR, {"Pac-Man World Rally", "PMR.exe"}},
};
...
void FOVChanger()
{
	if (eGameType == Game::PMWR && bFixActive == true)
	{
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "D9 44 24 ?? 56 D8 0D ?? ?? ?? ?? 8B F1");
