...
double currentCameraFOVInRadians, currentCameraFOVInDegrees, newCameraFOVInRadians, newCameraFOVInDegrees, oldWidth = 4.0, oldHeight = 3.0, oldCameraHorizontalFOV = 90.0, oldAspectRatio = oldWidth / oldHeight, newCameraFOVValue;
...
double NewCameraInDegreesFOVCalculation(uint32_t &newWidthValue, uint32_t &newHeightValue)
{
