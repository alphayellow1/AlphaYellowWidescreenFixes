...
float currentCameraFOVInRadians, currentCameraFOVInDegrees, newCameraFOVInRadians, newCameraFOVInDegrees, oldWidth = 4.0f, oldHeight = 3.0f, oldCameraHorizontalFOV = 90.0f, oldAspectRatio = oldWidth / oldHeight, newCameraFOVValue;
...
float NewCameraInDegreesFOVCalculation(uint32_t &newWidthValue, uint32_t &newHeightValue)
{
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            newCameraFOVInDegrees = NewCameraInDegreesFOVCalculation(newWidth, newHeight);
        ...
        if (file.good())
        {
            ...
            cout << "\nSuccessfully " << descriptor << " the field of view to " << newCameraFOVInDegrees << "\u00B0." << endl;
        }
        else
        {
