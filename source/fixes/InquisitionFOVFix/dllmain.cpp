...
void FOVFix()
{
	if (eGameType == Game::INQUISITION && bFixActive == true)
	{
		...
		{
			spdlog::info("Aspect Ratio Instruction 1: Address is fnx_dx8.dll+{:x}", AspectRatioInstructionsScanResult[AR1] - (std::uint8_t*)dllModule2);

			spdlog::info("Aspect Ratio Instruction 2: Address is fnx_dx8.dll+{:x}", AspectRatioInstructionsScanResult[AR2] - (std::uint8_t*)dllModule2);
			...
			AspectRatioInstruction1Hook = safetyhook::create_mid(AspectRatioInstructionsScanResult[AR1], [](SafetyHookContext& ctx)
			{
				...
				else if (fCurrentAspectRatio == 1.0f)
				{
			...
			AspectRatioInstruction2Hook = safetyhook::create_mid(AspectRatioInstructionsScanResult[AR2], [](SafetyHookContext& ctx)
			{
				...
				{
					fNewAspectRatio3 = fCurrentAspectRatio * fAspectRatioScale;
				}
				else
				{
		...
		{
			spdlog::info("Camera FOV Instruction 1: Address is fnx_dx8.dll+{:x}", CameraFOVInstructionsScanResult[FOV1] - (std::uint8_t*)dllModule2);

			spdlog::info("Camera FOV Instruction 2: Address is fnx_dx8.dll+{:x}", CameraFOVInstructionsScanResult[FOV2] - (std::uint8_t*)dllModule2);
			...
			CameraFOVInstruction1Hook = safetyhook::create_mid(CameraFOVInstructionsScanResult[FOV1], [](SafetyHookContext& ctx)
			{
				...
				if (fCurrentCameraFOV1 != 0.785398185253f && fCurrentCameraFOV1 != 0.480342030525f)
				{
			...
			CameraFOVInstruction2Hook = safetyhook::create_mid(CameraFOVInstructionsScanResult[FOV2], [](SafetyHookContext& ctx)
			{
				...
				if (fCurrentCameraFOV2 != 0.785398185253f && fCurrentCameraFOV2 != 0.480342030525f)
				{
