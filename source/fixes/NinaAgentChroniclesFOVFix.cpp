...
const double kDefaultCameraVerticalFOVInRadians = 1.361356854;
const streampos kCameraHorizontalFOVOffset = 0x0018CA71;
const streampos kCameraVerticalFOVOffset = 0x0018CA81;
...
int main()
{
    ...
    do
    {
        OpenFile(file, "LOCALE/CSHELL.DLL");
