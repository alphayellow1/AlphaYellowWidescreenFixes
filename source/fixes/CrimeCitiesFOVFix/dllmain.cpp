...
// Fix details
std::string sFixName = "CrimeCitiesFOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::CC, {"Crime Cities", "CRIMECITIES.EXE"}},
};
...
void FOVFix()
{
	if (eGameType == Game::CC && bFixActive == true)
	{
		...
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "D8 0D ?? ?? ?? ?? D9 54 24 20 DE C9 D9 C0");
