...
// Fix details
std::string sFixName = "FDNYFirefighterAmericanHeroFOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::FDNYFAH, {"F.D.N.Y. Firefighter: American Hero", "FDNYFirefighter.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::FDNYFAH && bFixActive == true)
	{
