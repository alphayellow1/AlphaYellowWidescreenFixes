...
void FOVFix()
{
	if (eGameType == Game::BVHS && bFixActive == true)
	{
		...
		if (Memory::AreAllSignaturesValid(CameraFOVInstructionsScansResult) == true)
		{
			...
			Memory::PatchBytes(CameraFOVInstructionsScansResult[CutscenesFOV1Scan], "\x90\x90\x90", 3);
			...
			Memory::PatchBytes(CameraFOVInstructionsScansResult[CutscenesFOV2Scan], "\x90\x90\x90", 3);
