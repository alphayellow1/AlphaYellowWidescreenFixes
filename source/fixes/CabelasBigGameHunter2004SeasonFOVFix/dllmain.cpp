...
const std::map<Game, GameInfo> kGames = {
	{Game::C4X4OA3, {"Cabela's Big Game Hunter 2004 Season", "Engine.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::C4X4OA3 && bFixActive == true)
	{
		...
		{
			spdlog::info("Inside Car Trigger Instruction: Address is GameDll.dll+{:x}", InsideCarTriggerInstructionScanResult + 3 - (std::uint8_t*)dllModule3);
