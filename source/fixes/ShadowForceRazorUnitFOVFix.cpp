...
float currentCameraFOV, currentWeaponFOV, newCameraFOV, newWeaponFOV, newCameraFOVValue, oldWidth = 4.0, oldHeight = 3.0, oldCameraHorizontalFOV, oldAspectRatio = oldWidth / oldHeight;
