...
{
    newCameraHorizontalFOVInDegreesValue = 2.0f * RadToDeg(atan((static_cast<float>(newWidthValue) / static_cast<float>(newHeightValue)) / oldAspectRatio) * tan(DegToRad(oldHorizontalFOV / 2.0f)));
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            newCameraHorizontalFOVInDegrees = NewHorizontalCameraFOVInDegreesCalculation(newHeight, newWidth);
