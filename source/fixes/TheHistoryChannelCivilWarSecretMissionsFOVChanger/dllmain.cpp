...
void FOVChanger()
{
	if (eGameType == Game::THCCWSM && bFixActive == true)
	{
		...
		if (CameraFOVInstruction1ScanResult)
		{
			...
			CameraFOV1Address = Memory::GetPointerFromAddress(CameraFOVInstruction1ScanResult + 2, Memory::PointerMode::Absolute);
		...
		if (CameraFOVInstruction2ScanResult)
		{
			...
			CameraFOV2Address = Memory::GetPointerFromAddress(CameraFOVInstruction2ScanResult + 40, Memory::PointerMode::Absolute);
		...
		if (CameraFOVInstruction3ScanResult)
		{
			...
			CameraFOV3Address = Memory::GetPointerFromAddress(CameraFOVInstruction3ScanResult + 28, Memory::PointerMode::Absolute);
		...
		if (CameraFOVInstruction4ScanResult)
		{
			...
			CameraFOV4Address = Memory::GetPointerFromAddress(CameraFOVInstruction4ScanResult + 2, Memory::PointerMode::Absolute);
		...
		if (ActorInitializeFOVInstructionScanResult)
		{
			...
			ActorInitializeFOVAddress = Memory::GetPointerFromAddress(ActorInitializeFOVInstructionScanResult + 2, Memory::PointerMode::Absolute);
		...
		if (WeaponReloadCameraFOVInstructionScanResult)
		{
			...
			WeaponReloadCameraFOVAddress = Memory::GetPointerFromAddress(WeaponReloadCameraFOVInstructionScanResult + 2, Memory::PointerMode::Absolute);
		...
		if (WeaponChangeCameraFOVInstructionScanResult)
		{
			...
			WeaponChangeCameraFOVAddress = Memory::GetPointerFromAddress(WeaponChangeCameraFOVInstructionScanResult + 2, Memory::PointerMode::Absolute);
		...
		if (WeaponResetCameraFOVInstruction1ScanResult)
		{
			...
			WeaponResetCamera1FOVAddress = Memory::GetPointerFromAddress(WeaponResetCameraFOVInstruction1ScanResult + 26, Memory::PointerMode::Absolute);
		...
		if (WeaponResetCameraFOVInstruction2ScanResult)
		{
			...
			WeaponResetCamera2FOVAddress = Memory::GetPointerFromAddress(WeaponResetCameraFOVInstruction2ScanResult + 2, Memory::PointerMode::Absolute);
		...
		if (WeaponPickupCameraFOVInstructionScanResult)
		{
			...
			WeaponPickupCameraFOVAddress = Memory::GetPointerFromAddress(WeaponPickupCameraFOVInstructionScanResult + 2, Memory::PointerMode::Absolute);
		...
		if (StartingSprintCameraFOVInstructionScanResult)
		{
			...
			StartingSprintCameraFOVAddress = Memory::GetPointerFromAddress(StartingSprintCameraFOVInstructionScanResult + 2, Memory::PointerMode::Absolute);
