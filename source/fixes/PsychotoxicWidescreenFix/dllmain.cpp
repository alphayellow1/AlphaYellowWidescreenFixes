...
{
	int& iCurrentCameraFOV = Memory::ReadMem(CameraFOVAddress);
...
void WidescreenFix()
{
	if (eGameType == Game::PSYCHOTOXIC && bFixActive == true)
	{
		...
		if (Memory::AreAllSignaturesValid(ResolutionInstructionsScansResult) == true)
		{
			...
			ResolutionHeight6Address = Memory::GetPointerFromAddress(ResolutionInstructionsScansResult[Resolution6Scan] + 8, Memory::PointerMode::Absolute);
			...
			ResolutionHeight7Address = Memory::GetPointerFromAddress(ResolutionInstructionsScansResult[Resolution7Scan] + 17, Memory::PointerMode::Absolute);
		...
		if (CameraHFOVInstructionScanResult)
		{
			...
			CameraHFOVAddress = Memory::GetPointerFromAddress(CameraHFOVInstructionScanResult + 2, Memory::PointerMode::Absolute);
