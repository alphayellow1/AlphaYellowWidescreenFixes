...
const std::map<Game, GameInfo> kGames = {
	{Game::FSW, {"Empire of the Ants", "Game.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::FSW && bFixActive == true)
	{
		...
		std::uint8_t* AspectRatioInstructionScanResult = Memory::PatternScan(dllModule2, "D9 05 ?? ?? ?? ?? C3 CC CC CC CC CC CC CC CC CC C7 01");
		...
		std::vector<std::uint8_t*> CameraFOVInstructionsScansResult = Memory::PatternScan(dllModule2, "D9 83 ?? ?? ?? ?? 8B 03", "8B 88 ?? ?? ?? ?? 8B 93 ?? ?? ?? ?? 83 C2", "F3 0F 11 81 F0 00 00 00 F3 0F 10 44 24 0C F3 0F 11 81 08 01 00 00 F3 0F 10 44 24 08 F3 0F 11 81 04 01 00 00");
		if (Memory::AreAllSignaturesValid(CameraFOVInstructionsScansResult) == true)
		{
			...
			spdlog::info("Camera FOV Instruction 3: Address is {}+{:x}", sDllName, CameraFOVInstructionsScansResult[CameraFOV3Scan] - (std::uint8_t*)dllModule2);
