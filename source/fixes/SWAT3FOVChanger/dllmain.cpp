...
void FOVChanger()
{
	...
	{
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "D9 86 8C 00 00 00 D8 0D ?? ?? ?? ?? 8B 54 24 08 D9 F2");
		if (CameraFOVInstructionScanResult)
		{
			...
			{
				float& fCurrentCameraFOV = Memory::ReadMem(ctx.esi + 0x8C);
