...
const double kDefaultCameraVerticalFOVInRadians = 0.87266469;
...
double currentCameraHorizontalFOVInDegrees, currentCameraVerticalFOVInDegrees, newCameraHorizontalFOVInDegrees, newCameraHorizontalFOVInDegreesValue, newCameraVerticalFOVInDegrees, currentCameraHorizontalFOVInRadians, currentCameraVerticalFOVInRadians, newCameraHorizontalFOVInRadians, newCameraVerticalFOVInRadians, oldWidth = 4.0, oldHeight = 3.0, oldCameraHorizontalFOV = 60.0, oldAspectRatio = oldWidth / oldHeight;
...
int main()
{
    ...
    cout << "Elite Forces Navy SEALs: Weapons of Mass Destruction (2002) FOV Fixer v1.0 by AlphaYellow, 2024\n\n----------------\n";
    ...
    do
    {
        ...
        case 2:
            cout << "\n- Enter the desired horizontal FOV (in degrees, default for 4:3 is 60\u00B0): ";
            HandleFOVInput(newCameraHorizontalFOVInDegrees);

            cout << "\n- Enter the desired vertical FOV (in degrees, default for 4:3 is 50\u00B0): ";
