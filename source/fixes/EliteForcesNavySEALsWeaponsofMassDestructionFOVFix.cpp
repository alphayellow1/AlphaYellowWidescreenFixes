...
float currentCameraHorizontalFOVInDegrees, currentCameraVerticalFOVInDegrees, newCameraHorizontalFOVInDegrees, newCameraHorizontalFOVInDegreesValue, newCameraVerticalFOVInDegrees, currentCameraHorizontalFOVInRadians, currentCameraVerticalFOVInRadians, newCameraHorizontalFOVInRadians, newCameraVerticalFOVInRadians, oldWidth = 4.0f, oldHeight = 3.0f, oldCameraHorizontalFOV = 60.0f, oldAspectRatio = oldWidth / oldHeight;
