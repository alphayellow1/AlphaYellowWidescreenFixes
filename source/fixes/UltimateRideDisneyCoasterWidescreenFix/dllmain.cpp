	...
	if (eGameType == Game::URDC && bFixActive == true)
	{
		...
		if (ResolutionListScanResult)
		{
			...
			*/
			...
			// 1280x1024
			Memory::Write(ResolutionListScanResult + 128, iCurrentResX);

			Memory::Write(ResolutionListScanResult + 134, iCurrentResY);

			// 800x600
			Memory::Write(ResolutionListScanResult + 149, iCurrentResX);

			Memory::Write(ResolutionListScanResult + 155, iCurrentResY);

			// HUD Resolution (800x600)
			Memory::Write(ResolutionListScanResult + 205, (int)(600 * fNewAspectRatio));

			Memory::Write(ResolutionListScanResult + 211, 600);
		}
		else
		{
