...
// Fix details
std::string sFixName = "UltimateRideDisneyCoasterWidescreenFix";
...
void WidescreenFix()
{
	if (eGameType == Game::URCD && bFixActive == true)
	{
		...
		std::uint8_t* ResolutionListScanResult = Memory::PatternScan(exeModule, "C7 01 00 04 00 00 C7 02 00 03 00 00 C3 8B 44 24 08 8B 4C 24 0C C7 00 80 04 00 00 C7 01 60 03 00 00 C3 8B 54 24 08 8B 44 24 0C C7 02 00 05 00 00 C7 00 C0 03 00 00 C3 8B 4C 24 08 8B 54 24 0C C7 01 40 06 00 00 C7 02 B0 04 00 00 C3 8B 44 24 08 8B 4C 24 0C C7 00 80 02 00 00 C7 01 E0 01 00 00 C3 8B 54 24 08 8B 44 24 0C C7 02 00 05 00 00 C7 00 00 03 00 00 C3 8B 4C 24 08 8B 54 24 0C C7 01 00 05 00 00 C7 02 00 04 00 00 C3 8B 44 24 08 8B 4C 24 0C C7 00 20 03 00 00 C7 01 58 02 00 00 C3 8D 49 00 55 C8 4C 00 6A C8 4C 00 7F C8 4C 00 94 C8 4C 00 A9 C8 4C 00 BE C8 4C 00 D3 C8 4C 00 90 90 90 90 8B 44 24 04 8B 4C 24 08 C7 00 20 03 00 00 C7 01 58 02 00 00");
		if (ResolutionListScanResult)
		{
			...
			*/
			...
			Memory::Write(ResolutionListScanResult + 107, iCurrentResX); // 1280

			Memory::Write(ResolutionListScanResult + 113, iCurrentResY); // 768

			Memory::Write(ResolutionListScanResult + 128, iCurrentResX); // 1280

			Memory::Write(ResolutionListScanResult + 134, iCurrentResY); // 1024

			Memory::Write(ResolutionListScanResult + 149, iCurrentResX); // 800

			Memory::Write(ResolutionListScanResult + 155, iCurrentResY); // 600

			// HUD Resolution
			Memory::Write(ResolutionListScanResult + 205, (int)(600 * fNewAspectRatio)); // 800

			Memory::Write(ResolutionListScanResult + 211, 600); // 600
		}
		else
		{
		...
		std::uint8_t* AspectRatioInstructionScanResult = Memory::PatternScan(exeModule, "D8 4E 04 D9 5C 24 0C D9 46 0C 8B 44 24 0C D8 66 08");
