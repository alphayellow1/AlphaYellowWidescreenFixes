...
// Fix details
std::string sFixName = "MonopolyTycoonFOVChanger";
...
const std::map<Game, GameInfo> kGames = {
	{Game::MT, {"Monopoly Tycoon", "mc.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::MT && bFixActive == true)
	{
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "8B 8E 04 65 01 00 52 50 51 51 D9 1C 24");
