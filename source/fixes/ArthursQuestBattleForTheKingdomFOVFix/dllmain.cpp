...
void FOVFix()
{
	if (eGameType == Game::AQBFTK && bFixActive == true)
	{
		...
		std::uint8_t* CameraHFOVInstructionScanResult = Memory::PatternScan(dllModule2, "89 B0 C4 00 00 00 8B 04 91 8B 74 24 10");
		if (CameraHFOVInstructionScanResult)
		{
			...
			CameraHFOVInstructionMidHook = safetyhook::create_mid(CameraHFOVInstructionScanResult, [](SafetyHookContext& ctx)
			{
				...
				Memory::ReadMem(ctx.eax + 0xC4) = fNewCameraHFOV;
			});
		}
		else
		{
		...
		std::uint8_t* CameraVFOVInstructionScanResult = Memory::PatternScan(dllModule2, "89 B0 C8 00 00 00 8B 0C 91 8B C6 8B 51 04 50 8B 44 24 10");
		if (CameraVFOVInstructionScanResult)
		{
			...
			CameraVFOVInstructionHook = safetyhook::create_mid(CameraVFOVInstructionScanResult, [](SafetyHookContext& ctx)
			{
				...
				Memory::ReadMem(ctx.eax + 0xC8) = fNewCameraVFOV;
			});
		}
		else
		{
