...
void FOVFix()
{
	if (eGameType == Game::MTMOTO && bFixActive == true)
	{
		...
		if (Memory::AreAllSignaturesValid(CameraFOVInstructionScansResult) == true)
		{
			spdlog::info("Camera FOV Instructions 1 Scan: Address is x3d.dll+{:x}", CameraFOVInstructionScansResult[CameraFOV1Scan] - (std::uint8_t*)dllModule2);

			spdlog::info("Camera FOV Instructions 2 Scan: Address is x3d.dll+{:x}", CameraFOVInstructionScansResult[CameraFOV2Scan] - (std::uint8_t*)dllModule2);

			spdlog::info("Camera FOV Instructions 3 Scan: Address is x3d.dll+{:x}", CameraFOVInstructionScansResult[CameraFOV3Scan] - (std::uint8_t*)dllModule2);

			spdlog::info("Camera FOV Instructions 4 Scan: Address is x3d.dll+{:x}", CameraFOVInstructionScansResult[CameraFOV4Scan] - (std::uint8_t*)dllModule2);

			spdlog::info("Camera FOV Instructions 5 Scan: Address is x3d.dll+{:x}", CameraFOVInstructionScansResult[CameraFOV5Scan] - (std::uint8_t*)dllModule2);

			dNewCameraFOV = (1.0 / (double)fAspectRatioScale) / dFOVFactor;

			Memory::PatchBytes(CameraFOVInstructionScansResult[CameraFOV1Scan], "\x90\x90\x90\x90\x90\x90", 6);

			CameraFOVInstruction1Hook = safetyhook::create_mid(CameraFOVInstructionScansResult[CameraFOV1Scan], CameraFOVInstructionMidHook);

			Memory::PatchBytes(CameraFOVInstructionScansResult[CameraFOV2Scan], "\x90\x90\x90\x90\x90\x90", 6);

			CameraFOVInstruction2Hook = safetyhook::create_mid(CameraFOVInstructionScansResult[CameraFOV2Scan], CameraFOVInstructionMidHook);

			Memory::PatchBytes(CameraFOVInstructionScansResult[CameraFOV3Scan], "\x90\x90\x90\x90\x90\x90", 6);

			CameraFOVInstruction3Hook = safetyhook::create_mid(CameraFOVInstructionScansResult[CameraFOV3Scan], CameraFOVInstructionMidHook);

			Memory::PatchBytes(CameraFOVInstructionScansResult[CameraFOV4Scan], "\x90\x90\x90\x90\x90\x90", 6);

			CameraFOVInstruction4Hook = safetyhook::create_mid(CameraFOVInstructionScansResult[CameraFOV4Scan], CameraFOVInstructionMidHook);

			Memory::PatchBytes(CameraFOVInstructionScansResult[CameraFOV5Scan], "\x90\x90\x90\x90\x90\x90", 6);

			CameraFOVInstruction5Hook = safetyhook::create_mid(CameraFOVInstructionScansResult[CameraFOV5Scan], CameraFOVInstructionMidHook);
		}
	}
}
