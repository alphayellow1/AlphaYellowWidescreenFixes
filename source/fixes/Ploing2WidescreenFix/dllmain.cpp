...
// Fix details
std::string sFixName = "Ploing2WidescreenFix";
...
void WidescreenFix()
{
	if (eGameType == Game::P2 && bFixActive == true)
	{
		...
		std::uint8_t* AspectRatioInstructionScanResult = Memory::PatternScan(exeModule, "D8 0D ?? ?? ?? ?? 5D");
