...
const double kDefaultCameraVerticalFOVInRadians = 0.8726646900177;
const streampos kCameraHorizontalFOVOffset = 0x000CC3D1;
const streampos kCameraVerticalFOVOffset = 0x000CC3E1;
