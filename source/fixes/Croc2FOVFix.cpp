...
// Constants
const streampos kHorizontalFOVOffset = 0x000A4780;
...
int main()
{
    ...
    do
    {
        ...
        newCameraHorizontalFOV = NewGameplayCameraHorizontalFOVCalculation(newWidth, newHeight);
