...
void FOVFix()
{
	if (eGameType == Game::SOAF && bFixActive == true)
	{
		...
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "D9 83 C8 01 00 00 D8 0D 50 7F 7E 00");
		if (CameraFOVInstructionScanResult)
		{
			...
			CameraFOVInstructionMidHook = safetyhook::create_mid(CameraFOVInstructionScanResult, [](SafetyHookContext& ctx)
			{
				...
				if (currentFOVValue == 1.5707963268f)
				{
				...
				if (currentFOVValue != lastModifiedFOV && currentFOVValue != fFOVFactor * (2.0f * atanf(tanf(1.5707963268f / 2.0f) * (fNewAspectRatio / fOldAspectRatio))))
				{
