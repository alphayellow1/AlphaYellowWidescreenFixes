...
// Fix details
std::string sFixName = "BeachVolleyballFOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::BV, {"Beach Volleyball", "Volleyball.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::BV && bFixActive == true)
	{
		...
		std::uint8_t* CameraFOVInstructionScanResult = Memory::PatternScan(exeModule, "D9 44 24 04 DC 0D 00 94 4B 00 8B 44 24 0C 8B 54 24 10 89 41 10 89 51 14 D9 F2 C6 41 18 00 DD D8 D8 4C 24 0C");
