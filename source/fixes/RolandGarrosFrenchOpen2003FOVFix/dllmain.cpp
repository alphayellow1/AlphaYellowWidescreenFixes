...
class RGO2003Fix final : public FixBase
{
public:
	explicit RGO2003Fix(HMODULE selfModule) : FixBase(selfModule)
	{
		s_instance_ = this;
	}
...
protected:
	...
	{
		return "RolandGarrosFrenchOpen2003FOVFix";
	}
	...
	{
		return "Roland Garros French Open 2003";
	}
	...
	void ApplyFix() override
	{
		...
		auto CameraFOVScanResult = Memory::PatternScan(ExeModule(), "89 98 ?? ?? ?? ?? 8B 29");
...
private:
	...
	inline static RGO2003Fix* s_instance_ = nullptr;
};

static std::unique_ptr<RGO2003Fix> g_fix;
