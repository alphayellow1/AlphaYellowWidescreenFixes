...
// Fix details
std::string sFixName = "AmericanMcGeePresentsBadDayLAFOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::AMGPBDL, {"American McGee presents: Bad Day L.A.", "BadDayLA.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::AMGPBDL && bFixActive == true)
	{
