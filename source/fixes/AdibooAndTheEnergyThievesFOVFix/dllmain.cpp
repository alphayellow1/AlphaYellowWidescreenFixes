...
// Fix details
std::string sFixName = "AdibooAndTheEnergyThievesFOVFix";
...
const std::map<Game, GameInfo> kGames = {
	{Game::AATET, {"Adiboo and the Energy Thieves", "Adiboo_Energy_Thieves.exe"}},
};
...
void FOVFix()
{
	if (eGameType == Game::AATET && bFixActive == true)
	{
